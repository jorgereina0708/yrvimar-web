...
const PRODUCTS = [
  ...
  P('pvc-no-toxica-textil', 'mangueras-pvc', 'prod/pvc-ari.webp', 'ficha/f-ari.webp',
    'Manguera No Tóxica con Refuerzo Textil (ARI)', 'Non-Toxic Textile-Reinforced Hose (ARI)',
    'Transparente grado alimenticio con trenzado de poliéster para alimentos, líquidos y aire.', 'Clear food-grade hose with polyester braid for food, liquids and air.'),
  P('pvc-no-toxica-sin-refuerzo', 'mangueras-pvc', 'prod/pvc-asi.webp', 'ficha/f-asi.webp',
    'Manguera No Tóxica sin Refuerzo (ASI)', 'Non-Toxic Unreinforced Hose (ASI)',
    'Transparente grado alimenticio, liviana y flexible para baja presión.', 'Clear food-grade hose, light and flexible for low pressure.'),
  ...
  P('hid-sae-100-r7-twin', 'mangueras-hidraulicas', 'prod/hid-r7-twin.webp', null,
    'Manguera Hidráulica SAE 100 R7 Twin (Doble Línea)', 'SAE 100 R7 Twin Line Hydraulic Hose',
    'Termoplástica de doble línea y no conductiva, ideal para plataformas elevadoras.', 'Non-conductive thermoplastic twin line, ideal for aerial work platforms.'),
  ...
  P('hid-sae-14', 'mangueras-hidraulicas', 'prod/hid-r14.webp', 'ficha/f-sae-14.webp',
    'Manguera Hidráulica SAE 100 R14 (PTFE)', 'SAE 100 R14 Hydraulic Hose (PTFE)',
    'Tubo interior de PTFE con trenza de acero inoxidable: químicos, vapor y altas temperaturas.', 'PTFE inner tube with stainless steel braid: chemicals, steam and high temperatures.'),
  ...
  P('niple-combinado', 'conexiones-industriales', 'prod/cind-niple-combinado-nci.webp', 'ficha/f-nci.webp',
  ...
  P('filtro-succion', 'conexiones-industriales', 'prod/cind-svi.webp', 'ficha/f-svi.webp',
  ...
  P('valvula-mariposa-wafer', 'valvulas-equipos', 'prod/val-valvula-mariposa-tipo-wafer.webp', 'ficha/f-mariposa-wafer.webp',
